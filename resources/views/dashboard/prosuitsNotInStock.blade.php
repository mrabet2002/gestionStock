                            ...
                            <div class="flex align-center">
                                ...
                                <div id="dropdownDivider" class="z-10 shadow-lg border-2 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                    ...
                                    <li class="cursor-pointer block flex justify-between px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">                                        
                                        ...
                                        <div class="py-2">
                                            <input id="2" value="1" type="radio" name="filtrer-par" class="filtrer-par w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded-full focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        </div>
                                    </li>
                                    <li class="cursor-pointer block flex justify-between px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">                                        
                                        <div class="py-2">
                                        ...
                                        <div class="pl-6 py-2">
                                            <input id="3" value="2" type="radio" name="filtrer-par" class="filtrer-par w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded-full focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        </div>
                                    </li>
                                    <li class="cursor-pointer block flex justify-between px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">                                        
                                        <div class="py-2">
                                        ...
                                        <div class="pl-6 py-2">
                                            <input id="4" value="3" type="radio" name="filtrer-par" class="filtrer-par w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded-full focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        </div>
                                    </li>
                                    <li class="cursor-pointer block flex justify-between px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">                                        
                                        <div class="py-2">
                                        ...
                                        <div class="pl-6 py-2">
                                            <input id="5" value="4" type="radio" name="filtrer-par" class="filtrer-par w-4 h-4 text-indigo-600 bg-gray-100 border-gray-300 rounded-full focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        </div>
                                    </li>
                                    </ul>
                                </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-white uppercase bg-indigo-500 dark:bg-gray-700 dark:text-gray-400">
                            <tr class="block relative">
                                <th scope="col" style="width:5%" class="py-4 px-4">
                                ...
                                <th scope="col" style="width:15%" class="px-6 py-3">
                                    <div class="flex justify-between">
                                        <div class="flex align-center">
                                            libelé
                                        </div>
                                        <div class="cursor-pointer rounded ordre-icone transition">
                                            <svg onclick="trierString(event, 1)" ordre="desc" id="trie-icone" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="cursor-pointer bi bi-arrow-down" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd" d="M8 1a.5.5 0 0 1 .5.5v11.793l3.146-3.147a.5.5 0 0 1 .708.708l-4 4a.5.5 0 0 1-.708 0l-4-4a.5.5 0 0 1 .708-.708L7.5 13.293V1.5A.5.5 0 0 1 8 1z"/>
                                            </svg>
                                        </div>
                                    </div>
                                </th>
                                <th scope="col" style="width:15%" class="py-3 px-6">
                                    <div class="flex justify-between">
                                        <div class="flex align-center">
                                            Fournisseur
                                        </div>
                        ...
                        <tbody class="block" style="height: 100vh; overflow: auto">
                            @foreach ($prosuitsNotInStock as $produit)
                                <tr class="cursor-pointer bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td scope="row" style="width: 15%" class="px-6 py-4 font-medium text-gray-900 dark:text-white">
                                        {{$produit->libele}}
                                    </td>
                                    <td scope="row" style="width: 15%" class="px-6 py-4">
                                    ...
                                    <td scope="row" style="width: 15%" class="py-4">
