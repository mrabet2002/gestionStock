<x-app-layout>
    <x-slot name="header">
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="sm:flex justify-between">
                <div class="py-2">
                    {{ __('Modifier les information de la marque : '.$marque->libele) }}
                </div>
                <div class="py-1">
    ...
    @section('content')
        ...
        <div class="containerc">
            <form action="{{route('marque.update', $marque)}}" method="POST" enctype="multipart/form-data" id="productData">
                @csrf
                <div class="sm:mt-0">
                            ...
                            <div class="mt-5 md:mt-0 card-body">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        value="{{old('libele') ? old('libele') : $marque->libele}}"
                                    ...
                                    <div class="col-span-6 ">
                                        ...
                                        <div class="mt-1">
                                            ...
                                            {{old('description') ? old('description') : $marque->description}}
                                        </textarea>
                                        </div>
