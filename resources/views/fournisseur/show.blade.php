<x-app-layout>
        ...
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="sm:flex justify-between">
                ...
                <div class="py-1">
                    ...
                    <button data-modal-toggle="supprimerfournisseur"
    ...
    @section('content')
        ...
        <div id="supprimerfournisseur" tabindex="-1"
                ...
                <div class="relative sm-modal-content bg-white rounded-lg shadow dark:bg-gray-700 md:w-1/2">
                    ...
                    <div class="flex justify-end p-2">
                        <button type="button"
                            ...
                            data-modal-toggle="supprimerfournisseur">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <form action="{{ route('fournisseur.destroy', $fournisseur->id) }}" method="post">
                            ...
                            <button data-modal-toggle="supprimerfournisseur" type="button"
                                    ...
                                    @if ($fournisseur->email)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 text-right w-full"><a
                                                    href="mailto:{{ $fournisseur->email }}">{{ $fournisseur->email }}</a>
                                            </td>
                                        </tr>
                                    @endif
                                    @if ($fournisseur->tel)
                                        <tr>
                                            <th
                                                ...
                                                Téléphone</th>
                                            <td class="px-6 py-4 text-right w-full"><a
                                                    href="tel:{{ $fournisseur->tel }}">{{ $fournisseur->tel }}</a></td>
                                        </tr>
                                    @endif
                                    ...
                                    @if ($fournisseur->site_web)
                                        <tr>
                                            <th
                                                class="px-6 py-4 text-sm uppercase text-left text-gray-900 dark:text-white whitespace-nowrap">
                                                Site Web</th>
                                            <td class="px-6 py-4 text-right w-full"><a href="{{ $fournisseur->site_web }}"
                                                    target="_blank">{{ $fournisseur->site_web }}</a></td>
                                        </tr>
                                    @endif
                                </table>
                            </div>
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6" style="height: fit-content">
                            ...
                            <div class="welcome-img">
                                <iframe width="100%" style="height: 100mm" csp="true" allowfullscreen="true"
                                    src="/uploads/{{ $fournisseur->fichier_attacher }}" frameborder="0"></iframe>
                            </div>
                        </div>
                    </div>
                @endif
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" class="px-6 py-3">
                                                    <div class="flex justify-between">
                                                        ...
                                                        <div class="cursor-pointer rounded ordre-icone transition">
                                                            <svg onclick="trierString(event, 2)" ordre="desc"
                                                                id="trie-icone" xmlns="http://www.w3.org/2000/svg"
                                                                width="16" height="16" fill="currentColor"
                                                                class="cursor-pointer bi bi-arrow-down"
                                                                viewBox="0 0 16 16">
                                                                <path fill-rule="evenodd"
                                                ...
                                                <th scope="col" class="px-6 py-3">
                                                    <div class="flex justify-between">
                                                        ...
                                                        <div class="cursor-pointer rounded ordre-icone transition">
                                                            <svg onclick="trierString(event, 3)" ordre="desc"
                                                                id="trie-icone" xmlns="http://www.w3.org/2000/svg"
                                                                width="16" height="16" fill="currentColor"
                                                                class="cursor-pointer bi bi-arrow-down"
                                                                viewBox="0 0 16 16">
                                                ...
                                                <th scope="col" class="px-6 py-3">
                                                    <div class="flex justify-between">
                                                        ...
                                                        <div class="cursor-pointer rounded ordre-icone transition">
                                                            <svg onclick="trierString(event, 4)" ordre="desc"
                                                                id="trie-icone" xmlns="http://www.w3.org/2000/svg"
                                                                width="16" height="16" fill="currentColor"
                                                                class="cursor-pointer bi bi-arrow-down"
                                                                viewBox="0 0 16 16">
                                                    ...
                                                    <td class="py-4">
                                                        <div class="flex justfy-between items-center">
                                                            ...
                                                            <a href="{{ route('produit.edit', $produit->id) }}"
                                                                class="px-3 edit-btn transition">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                            ...
                                                            <a data-modal-toggle={{ 'supprimerProduit' . $produit->id }}
                                                                type="button"
                                                                class="delete-product px-3 text-red-500 delete-btn transition">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                    height="16" fill="currentColor"
                                                        ...
                                                        <div id={{ 'supprimerProduit' . $produit->id }} tabindex="-1"
                                                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-full md:h-full">
                                                            <div
                                                                class="relative modal-container w-full max-w-md h-full md:h-auto">
                                                                <!-- Modal content -->
                                                                <div
                                                                    class="relative sm-modal-content bg-white rounded-lg shadow dark:bg-gray-700 md:w-1/2">
                                                                    <!-- Modal header -->
                                                                    <div class="flex justify-end p-2">
                                                                        <button type="button"
                                                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                                                            data-modal-toggle={{ 'supprimerProduit' . $produit->id }}>
                                                                    ...
                                                                    <!-- Modal body -->
                                                                    <div class="p-6 pt-0 text-center">
                                                                        <svg class="mx-auto mb-4 text-gray-400 dark:text-gray-200"
                                                                            width="10%" fill="none"
                                                                        ...
                                                                        <form
                                                                            action="{{ route('produit.destroy', $produit->id) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            <button type="submit"
                                                                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm inline-flex items-center px-2 py-2 text-center mr-2">
