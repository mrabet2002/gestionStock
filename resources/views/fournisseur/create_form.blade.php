<div class="containerc">
    <form action="{{$route}}" method="POST" enctype="multipart/form-data" id="fournisseurData">
        @csrf
        <div class="sm:mt-0">
                    ...
                    <div class="mt-5 md:mt-0 card-body">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6">
                                ...
                                value="{{old('nom') ? old('nom') : (isset($fournisseur) ? $fournisseur->name : "")}}" 
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                (isset($fournisseur) ? $fournisseur->tel : "")}}" 
                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            </div>                        
                            ...
                            <div class="col-span-6 ">
                                ...
                                <div class="mt-1">
                                    <textarea id="description" name="description" rows="6" class="w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md">
                                        ...
                                        (isset($fournisseur) ? $fournisseur->description : "")}}
                                    </textarea>
                                </div>
                        ...
                        <div class="mt-5 md:mt-0 card-body">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6">
                                    ...
                                    (isset($fournisseur) ? $fournisseur->adresse : "")}}'
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    (isset($fournisseur) ? $fournisseur->pays : "")}}'
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    (isset($fournisseur) ? $fournisseur->ville : "")}}'
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                ...
                                <div class="col-span-6">
                                    ...
                                    (isset($fournisseur) ? $fournisseur->code_postal : "")}}'
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-5 md:mt-0 card-body">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    (isset($fournisseur) ? $fournisseur->email : "")}}'
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    (isset($fournisseur) ? $fournisseur->site_web : "")}}'
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                <div class="col-span-6">
                                    ...
                                    (isset($fournisseur) ? $fournisseur->devise : "")}}'
                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                </div>
                                <div class="col-span-6">
