    ...
    @section('content')
        ...
        @endif
            <div class="containerc">
                <form action="{{route('facture.store')}}" method="POST" enctype="multipart/form-data" id="factureData">
                    @csrf
                    <div class="sm:mt-0">
                                ...
                                <div class="mt-5 md:mt-0 card-body">
                                    <div class="grid grid-cols-6 gap-6">                     
                                        <div class="col-span-6">
                                            ...
                                            <input type="number" step="0.01" name="num_facture" id="num_facture" value="{{old('num_facture') ? old('num_facture') : $num_facture}}" required class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                ...
                                <div class="mt-5 md:mt-0 card-body">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <div class="mt-1 flex rounded-md shadow-sm">
                                                <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm"> % </span>
                                                <input type="number" step="0.01" name="tva" id="tva" value="{{old('tva')}}" 
                                                class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="col-span-6">
                                        ...
                                        class="mt-1 block w-full px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                            ...
                                            <option value="non-payee" {{old('statut_paiment') == "non-payee" ? "selected" : ""}}>Non payée</option>
                                        </select>
                                    </div>
                        ...
                        <div class="">
                            <div class="card shadow-md">
                                <div class="flex justify-start card-head">
                                    <div class="px-4 sm:px-0">
                                        <h3 class="text-lg font-bold leading-6 text-gray-900">Ventes</h3>
                                    </div>
                                </div><hr>
                                <div class="card-body relative">
                                    <div class="py-6">
                                        <label for="table-search">Choisir un client</label>
                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        <thead class="text-xs text-white uppercase bg-indigo-500 dark:bg-gray-700 dark:text-gray-400">
                                            ...
                                            @if ($clients_ventes->count() > 0)
                                                ...
                                                <tbody id="tbody_{{$id_client}}" class="{{old('client') != $id_client ? 'hidden' : ""}}">
                                                    <tr id="row_{{$id_client}}" class="cursor-pointer bg-gray-200 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                        ...
                                                        @foreach ($ventes as $vente)
                                                            <tr class="cursor-pointer bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                                <td class="w-4 px-4">
                                                                    <div class="flex items-center">
                                                                        <input id="{{$vente->id}}" value="{{$vente->id}}" name="ventes[{{$vente->id}}]" type="checkbox" class="checkbox_row_{{$id_client}} w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                                    </div>
                                                                </td>
