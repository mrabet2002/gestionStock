<x-app-layout>
    ...
    @section('content')
        ...
        <div id="supprimerclient" tabindex="-1"
                ...
                <div class="relative sm-modal-content bg-white rounded-lg shadow dark:bg-gray-700 md:w-1/2">
                    ...
                    <div class="flex justify-end p-2">
                        <button type="button"
                            ...
                            data-modal-toggle="supprimerclient">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <form action="{{ route('client.destroy', $client->id) }}" method="post">
                            ...
                            <button data-modal-toggle="supprimerclient" type="button"
        ...
        @if (session()->has('success'))
            <div class="success-container">
                <div class="success bg-red-100 border px-3 py-3 rounded-lg" role="alert">
                    <svg class="dark:text-gray-200" width="5%" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                    ...
                                    @if ($client->tel)
                                        <tr>
                                            <th
                                                ...
                                                Téléphone</th>
                                            <td class="px-6 py-4 text-right w-full"><a
                                                    href="tel:{{ $client->tel }}">{{ $client->tel }}</a></td>
                                        </tr>
                                    @endif
                                    @if ($client->adresse)
                                        <tr>
                                    ...
                                    @if ($client->site_web)
                                        <tr>
                                            <th
                                                class="px-6 py-4 text-sm uppercase text-left text-gray-900 dark:text-white whitespace-nowrap">
                                                Site Web</th>
                                            <td class="px-6 py-4 text-right w-full"><a href="{{ $client->site_web }}"
                                                    target="_blank">{{ $client->site_web }}</a></td>
                                        </tr>
                                    @endif
                                </table>
                            </div>
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-6" style="height: fit-content">
                            ...
                            <div class="welcome-img">
                                <iframe width="100%" style="height: 100mm" csp="true" allowfullscreen="true"
                                    src="/uploads/{{ $client->fichier_attacher }}" frameborder="0"></iframe>
                            </div>
                        </div>
                    </div>
                @endif
