    ...
    <x-slot name="header">
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="sm:flex justify-between">
                ...
                <div class="py-1">
                        <form action="{{route('client.edit',$client->id)}}" id="modifierProd"></form>
                        ...
                        <button data-modal-toggle="supprimerclient" class="inline-flex items-center btn btn-red transition">
                            <span class="mr-3">
                                Supprimer
                            </span>
                        ...
                        <div id="supprimerclient"  tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-full md:h-full">
                            <div class="relative modal-container w-full max-w-md h-full md:h-auto">
                                ...
                                <div class="relative sm-modal-content bg-white rounded-lg shadow dark:bg-gray-700 md:w-1/2">
                                    ...
                                    <div class="flex justify-end p-2">
                                        <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="supprimerclient" >
                                    ...
                                    <div class="p-6 pt-0 text-center">
                                        ...
                                        <form action="{{route('client.destroy',$client->id)}}" method="post">
                                            ...
                                            <button data-modal-toggle="supprimerclient"  type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none rounded-lg border border-gray-200 text-sm font-medium px-2 py-2 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                                Non
                                            </button>
                                        </form>
                                    </div>
                            ...
                            <table>
                                ...
                                @if ($client->code_postal)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-right w-full">{{$client->code_postal}}</td>
                                    </tr>
                                @endif
                                @if ($client->site_web)
                                    <tr>
                                        <th class="px-6 py-4 text-sm uppercase text-left text-gray-900 dark:text-white whitespace-nowrap">Site Web</th>
                                        <td class="px-6 py-4 text-right w-full"><a href="{{$client->site_web}}" target="_blank">{{$client->site_web}}</a></td>
                                    </tr>
                                @endif
                            </table>
                        </div>
            ...
            @if ($client->description)
                <div class="col">
                    <div class="bg-white shadow-lg rounded-lg p-6" style="height: fit-content">
                        ...
                        <div class="py-2"><hr></div>
                        <p style="text-align: justify">{{$client->description}}</p>
                    </div>
                </div>
            @endif
            @if ($client->fichier_attacher)
                <div class="col">
                    <div class="bg-white shadow-lg rounded-lg p-6" style="height: fit-content">
                        <h1 class="text-xl font-bold">Fichier attacher</h1>
                        <div class="py-2"><hr></div>
                        <div class="welcome-img">
                            <iframe width="100%" style="height: 100mm" csp="true" allowfullscreen="true" src="/uploads/{{$client->fichier_attacher}}" frameborder="0"></iframe>
                        </div>
                    </div>
                </div>
            @endif
