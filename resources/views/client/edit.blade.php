<x-app-layout>
    <x-slot name="header">
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="sm:flex justify-between">
                <div class="py-2">
                    {{ __('Modifier les information du client : '.$client->name) }}
                </div>
                <div class="py-1">
                        ...
                        <button type="submit" form="clientData" class="inline-flex btn btn-indigo transition">
                            <span class="mr-3">
                                Enregistrer
                            </span>
    ...
    @section('content')
        ...
        @endif
        @php
            $route = route('client.update', $client)
        @endphp
            ...
            <div class="relative modal-container w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative sm-modal-content bg-white rounded-lg shadow dark:bg-gray-700 md:w-1/2">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <a href="{{route('client.index')}}" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm inline-flex items-center px-2 py-2 text-center mr-2">
                            Oui, je suis sur
                        </a>
