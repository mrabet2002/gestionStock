        ...
        <h2 class="flex justify-between font-semibold text-xl text-gray-800 leading-tight">
            ...
            <div class="text-right">
                <span class="rounded-md">
                    <a href="{{route('categorie.create')}}" type="button" class="cursor-pointer btn-indigo inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white bg-indigo-500 active:bg-gray-50 transition">
                        <span class="mr-3">
                            Créer Une Categorie
                        </span>
                    ...
                    <div class="py-3 px-3">
                        ...
                        <div class="md:grid md:grid-cols-2 gap-6">
                            ...
                            <div class="flex justify-end align-center">
                                <form action="{{route('categorie.export')}}" method="post" id="expotercategories">
                                    @csrf
                                    <button class="btn btn-blue w-fit mr-2" form="expotercategories">
                                        Exporter
                                    </button>
                                </form>
                                <form action="{{route('categorie.import')}}" method="post" enctype="multipart/form-data" id="importercategories">
                                    @csrf
                                    <label class="btn btn-orange w-fit">
                                        <span>Importer</span>
                                        <input class="file-input sr-only" type="file" name="importercategories" id="importercategories" form="importercategories" onchange="document.querySelector('form#importercategories').submit()">
                                    </label>
                                </form>
                            </div>
                        </div>
                            ...
                            <tbody class="table-body">
                                @foreach ($categories as $categorie)
                                    <tr class="cursor-pointer bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="w-4 px-4">
                                            <div class="flex items-center">
                                                <input form="expotercategories" id="{{$categorie->id}}" value="{{$categorie->id}}" name="categories[{{$categorie->id}}]" type="checkbox" class="checkboxs w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-4">
                                            <div class="flex justfy-between items-center">
                                                ...
                                                <a href="{{route('categorie.edit',$categorie->id)}}" class="px-3 edit-btn transition">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                                                        <path d="M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708l-3-3zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207l6.5-6.5zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.499.499 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11l.178-.178z"/>
                                                    </svg>
                                                </a>
                                                
                                                <a data-modal-toggle={{"supprimercategorie".$categorie->id}} type="button" class="delete-product px-3 text-red-500 delete-btn transition">
                                                ...
                                                <div class="relative modal-container w-full max-w-md h-full md:h-auto">
                                                    ...
                                                    <div class="relative sm-modal-content bg-white rounded-lg shadow dark:bg-gray-700 md:w-1/2">
                                                        ...
                                                        <div class="flex justify-end p-2">
                                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle={{"supprimercategorie".$categorie->id}} >
                                                        ...
                                                        <div class="p-6 pt-0 text-center">
                                                            ...
                                                            <form action="{{route('categorie.destroy',$categorie->id)}}" method="post">
                                                                ...
                                                                <button data-modal-toggle={{"supprimercategorie".$categorie->id}}  type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none rounded-lg border border-gray-200 text-sm font-medium px-2 py-2 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                                                    Non
                                                                </button>
                                                            </form>
                                                        </div>
