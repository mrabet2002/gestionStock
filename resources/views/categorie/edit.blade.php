<x-app-layout>
    <x-slot name="header">
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="sm:flex justify-between">
                <div class="py-2">
                    {{ __('Modifier les information de la catégorie : '.$categorie->libele) }}
                </div>
                <div class="py-1">
    ...
    @section('content')
        ...
        <div class="containerc">
            <form action="{{route('categorie.update', $categorie)}}" method="POST" enctype="multipart/form-data" id="productData">
                @csrf
                <div class="sm:mt-0">
                            ...
                            <div class="mt-5 md:mt-0 card-body">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        value="{{old('libele') ? old('libele') : $categorie->libele}}"
                                    ...
                                    <div class="col-span-6 ">
                                        ...
                                        <div class="mt-1">
                                            ...
                                            {{old('description') ? old('description') : $categorie->description}}
                                        </textarea>
                                        </div>
            ...
            <div class="relative modal-container w-full max-w-md h-full md:h-auto">
                ...
                <div class="relative sm-modal-content bg-white rounded-lg shadow dark:bg-gray-700 md:w-3/4">
                    ...
                    <div class="p-6 pt-0 text-center">
                        ...
                        <a href="{{route('categorie.index')}}" type="button" class="text-white bg-red-600 hover:bg-red-500 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm inline-flex items-center px-2 py-2 text-center mr-2">
                            Oui, je suis sur
                        </a>
