    ...
    @section('content')
        ...
        <div class="containerc">
            <form action="{{route('produit.update', $produit->id)}}" method="POST" enctype="multipart/form-data" id="productData">
                @csrf
                <div class="sm:mt-0">
                    <div class="md:grid md:grid-cols-2 gap-x-6 overflow-hidde">
                            ...
                            <div class="mt-5 md:mt-0 card-body">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6">
                                        ...
                                        value="{{old('libele') ? old('libele') : $produit->libele}}"
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        value="{{old('unite') ? old('unite') : $produit->unite}}"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        value="{{old('code_barre') ? old('code_barre') : $produit->code_barre}}"
                                        class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                    </div>
                                    <div class="col-span-6 ">
                        ...
                        <div class="md:grid gap-2">
                            <div class="card shadow-md">
                                ...
                                <div class="mt-5 md:mt-0 card-body">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="min_stock" class="block text-sm font-medium text-gray-700">Niveau de stock minimal</label>
                                            <input type="number" step="0.01" name="min_stock" id="min_stock" 
                                            value="{{old('min_stock') ? old('min_stock') : $produit->min_stock}}"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            value="{{old('prix_initial') ? old('prix_initial') : $produit->prix_initial}}"
                                            class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                                        </div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                                    ...
                                                    @else
                                                        @foreach ($fournisseurs as $fournisseur)
                                                            <option value="{{$fournisseur->id}}" 
                                                                {{old('fournisseur') ? ($fournisseur->id == old('fournisseur') ? "selected" : "") :
                                                                ($fournisseur->id == $produit->fournisseur->id ? "selected" : "")}}>
                                                                {{$fournisseur->name}}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <div class="mt-1 flex rounded-md shadow-sm">
                                                ...
                                                value="{{old('poids') ? old('poids') : $produit->poids}}"
