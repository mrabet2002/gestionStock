<x-app-layout>
    <x-slot name="header">
        <div class="font-semibold text-xl text-gray-800 leading-tight">
            <div class="sm:flex justify-between">
                ...
                <div class="py-1">
                    <form action="{{route('produit.edit',$produit->id)}}" id="modifierProd"></form>
    ...
    @section('content')
        ...
        <div id="supprimerProduit"  tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-200 md:inset-0 h-full md:h-full">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    <div class="flex align-center justify-center py-12 bg-gray-50 rounded-md">
                        <div class="welcome text-center">
                            ...
                            <p class="hidden code_barre">{{$produit->code_barre}}</p>
