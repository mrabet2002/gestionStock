                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="welcome-img">
                        @if ($stock->produit->image)
                            <img width="100%" src="/uploads/{{$stock->produit->image}}" class="rounded-md" alt="{{$stock->produit->libele}}">
                        @else
            ...
            <div class="grid md:grid-cols-2 gap-6 mt-6">
                ...
                <div class="bg-white shadow-lg rounded-lg p-6">
                    ...
                    <table>
                        ...
                        @if ($stock->prix_achat)
                            <tr>
                                <th class="px-6 py-4 text-sm uppercase text-left text-gray-900 dark:text-white whitespace-nowrap">Prix d'achat</th>
