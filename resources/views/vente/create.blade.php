                                                ...
                                                {{-- @foreach ($produits as $produit)
                                                        <tr id="{{$produit->id}}" style="{{$produit->fournisseur->id == old('fournisseur') ? "display:none;" : ""}}" class="cursor-pointer bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                            ...
                                                            <td class="prixCell px-6 py-4">
                                                                <div class="col-span-6">
                                                                    <input type="number" step="0.01" name="lignesVente[{{$produit->id}}][prix]" 
                                                                    value="{{old('lignesVente.'.$produit->id.'.prix') ? old('lignesVente.'.$produit->id.'.prix') : $produit->prix_initial}}" 
                                                                    class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                            ...
                                                            <td class="px-6 py-4">
                                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                                    <input type="number" name="lignesVente[{{$produit->id}}][qte_demandee]" 
                                                                    value="{{old('lignesVente.'.$produit->id.'.qte_demandee') ? old('lignesVente.'.$produit->id.'.qte_demandee') : 0}}" 
                                                                    class="qte-input focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                                                                    onkeyup="calculatTotal(event)"
                                                                    onclick="resetValue(event)">
                                                                </div>
                                                            ...
                                                            <td class="px-6 py-4">
                                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                                    <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm"> % </span>
                                                                    <input type="number" name="lignesVente[{{$produit->id}}][remise]" 
                                                                    value="{{old('lignesVente.'.$produit->id.'.remise') ? old('lignesVente.'.$produit->id.'.remise') : 0}}" 
                                                                    class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                                                                    onkeyup="calculatTotal(event)"
                                                                    onclick="resetValue(event)">
                                                                </div>
                                                            ...
                                                            <td class="px-6 py-4">
                                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                                    <input type="date" name="lignesVente[{{$produit->id}}][date_expiration]" value="{{old('lignesVente.'.$produit->id.'.date_expiration')}}" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300">
                                                                </div>
                                                            </td>
                                                            <td class="px-6 py-4">
                                                                <div class="mt-1 flex rounded-md shadow-sm">
                                                                    <input type="number" step="0.01" name="lignesVente[{{$produit->id}}][total]" value="{{old('lignesVente.'.$produit->id.'.total')}}" class="total-input focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach --}}