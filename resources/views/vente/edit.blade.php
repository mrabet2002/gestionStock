                                                ...
                                                ondragover="dragOver(event)">
                                                    ...
                                                    @else
                                                        @foreach ($vente->produits as $produit)
                                                            <tr draggable="true" id="ligneVente-{{$produit->id}}" 
                                                            class="cursor-pointer bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                                                            ondragstart="dragStart(event)"
                                                            ondragend="dragEnd(event)">
                                                                <td class="produitCell px-6 py-4 font-medium text-gray-900 dark:text-white" style="width: 17%">
                                                                ...
                                                                <td class="prixCell px-2 py-4" style="width: 15%">
                                                                    <div class="col-span-6">
                                                                        <input type="number" step="0.01" name="lignesVente[{{$produit->id}}][prix]" value="{{$produit->pivot->prix}}" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                                                                        onkeyup="calculatTotal(event, 'table-lignesvente-body', 'remiseVente')">
                                                                    </div>
                                                                </td>
                                                                <td class="px-2 py-4" style="width: 15%">
                                                                    <div class="mt-1 flex rounded-md shadow-sm">
                                                                        <input type="number" name="lignesVente[{{$produit->id}}][qte_demandee]" value="{{$produit->pivot->qte_demandee}}" class="qte-input focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-md sm:text-sm border-gray-300"
                                                                        onkeyup="calculatTotal(event, 'table-lignesvente-body', 'remiseVente')"
                                                                        onclick="resetValue(event)">
                                                                    </div>
                                                                </td>
                                                                <td class="px-2 py-4" style="width: 15%">
                                                                    <div class="mt-1 flex rounded-md shadow-sm">
                                                                        <span class="inline-flex items-center px-3 rounded-l-md border border-r-0 border-gray-300 bg-gray-50 text-gray-500 text-sm"> % </span>
                                                                        <input type="number" name="lignesVente[{{$produit->id}}][remise]" value="{{$produit->pivot->remise}}" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                                                                        onkeyup="calculatTotal(event, 'table-lignesvente-body', 'remiseVente')"
                                                                        onclick="resetValue(event)">
                                                                    </div>
                                                                </td>
